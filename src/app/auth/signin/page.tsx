    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400">Sign in to start your GSA MAS application</p>
        </div>
        ...
        {error && (
          <div className="mb-6 p-4 rounded-xl bg-red-500/10 border border-red-500/20 text-red-400 text-sm text-center">
            ...
            {!['OAuthSignin', 'OAuthCallback', 'OAuthAccountNotLinked'].includes(error) && 'An error occurred. Please try again.'}
          </div>
        )}
        ...
        <div className="card space-y-4">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-white text-slate-900 font-semibold rounded-xl hover:bg-slate-100 transition-all"
          >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-[#0A66C2] text-white font-semibold rounded-xl hover:bg-[#004182] transition-all"
          >
